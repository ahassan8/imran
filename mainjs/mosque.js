...
function searchMosques() {
    ...
    const filteredMosques = mosqueData.filter(mosque =>
        ...
        (mosque.phone && mosque.phone.toLowerCase().includes(locationInputValue))
    );
...
function displayMosques(mosques, container, message) {
    ...
    mosques.forEach(mosque => {
        ...
        mosqueDiv.innerHTML = `
            ...
            <p><strong>Phone:</strong> ${mosque.phone || "NA"}</p>
            <p><strong>Website:</strong> ${
                mosque.website && mosque.website.toLowerCase() !== "not available" && mosque.website.trim() !== ""
